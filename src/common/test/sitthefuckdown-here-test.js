...
/* global _, $, SitthefuckdownRender, htmlToText, marked, hljs, Utils, MdhHtmlToText, sitthefuckdownHere */

// TODO: Lots more tests.

describe('sitthefuckdownHere', function() {
  it('should exist', function() {
    expect(sitthefuckdownHere).to.exist;
  });
  ...
  describe('sitthefuckdownHere', function() {
    ...
    var sitthefuckdownRenderHelper = function(elem, range, callback) {
      ...
      callback(renderedSitthefuckdown, userprefs['main-css'] + userprefs['syntax-css']);
    };
    ...
    var doneCaller = function(expectedInnerHtml, done) {
      ...
      return function(elem) {
        var renderedHTMLRegex = /^<div class="sitthefuckdown-here-wrapper" data-md-url="[^"]+">([\s\S]*)<div title="MDH:[\s\S]+">[\s\S]*<\/div><\/div>$/;
    ...
    it('should unrender a reply to a rendered email', function(done) {
      var replyMD = '_bye_';
      var fullReplyMD = replyMD+'<br><div class="gmail_quote">On Fri, Aug 14, 2015 at 10:34 PM, Billy Bob <span dir="ltr">&lt;<a href="mailto:bb@example.com" target="_blank">bb@example.com</a>&gt;</span> wrote:<br><blockquote><div class="sitthefuckdown-here-wrapper" data-md-url="xxx"><p><em>hi</em></p>\n<div title="MDH:X2hpXw==" style="height:0;width:0;max-height:0;max-width:0;overflow:hidden;font-size:0em;padding:0;margin:0;">​</div></div></blockquote></div>';
      // First render
