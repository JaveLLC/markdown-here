...
/*
 * The function that does the basic raw-Sitthefuckdown-in-HTML to rendered-HTML
 * conversion.
 * The reason we keep this function -- specifically, the function that uses our
 * external sitthefuckdown renderer (marked.js), text-from-HTML module (jsHtmlToText.js),
...
var SitthefuckdownRender = {};


/**
 Using the functionality provided by the functions htmlToText and sitthefuckdownToHtml,
 render html into pretty text.
 */
function sitthefuckdownRender(mdText, userprefs, marked, hljs) {
  ...
  var renderedSitthefuckdown = marked(mdText, markedOptions);
...
SitthefuckdownRender.sitthefuckdownRender = sitthefuckdownRender;

var EXPORTED_SYMBOLS = ['SitthefuckdownRender'];

if (typeof module !== 'undefined') {
  module.exports = SitthefuckdownRender;
} else {
  this.SitthefuckdownRender = SitthefuckdownRender;
